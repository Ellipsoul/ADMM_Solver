...
#-------------------------------------------------------------------------------------------------------------------
"""
- Update Time Proportion vs numEl
Extra graph added at the end
Splitting and no splitting on separate graphs
Plot the proportion of time distribution as it changes with number of independent variables
...
plt.plot(df['num_el_real'], df['y_prop'], '+--', linewidth=1.5, markersize=5)
plt.plot(df['num_el_real'], df['z_prop'], '+--', linewidth=1.5, markersize=5)
plt.plot(df['num_el_real'], df['lagrange_prop'], '+--', linewidth=1.5, markersize=5)
plt.plot(df['num_el_real'], df['setup_prop'], '+--', linewidth=1.5, markersize=5)

# Title
titleDict = { 'size': 12, 'weight': 'semibold'}
plt.suptitle("CPU Time Distribution vs Number of Independent Variables", fontproperties=titleDict, y=0.96)
subtitleDict = { 'fontsize': 9, 'fontweight': 'normal', 'verticalalignment': 'baseline'}
plt.title(r"$\omega=1$, No Splitting", fontdict=subtitleDict, pad=7)

# Lables and legend
plt.xlabel("# Independent Variables", fontsize=10)
plt.ylabel("Proportion of CPU Time", fontsize=10)
plt.legend(["Y Update", "z Update", "Lagrange Update", "Setup"], loc=0)
...
plt.suptitle("CPU Time Distribution vs Number of Independent Variables", fontproperties=titleDict, y=0.96)
subtitleDict = { 'fontsize': 9, 'fontweight': 'normal', 'verticalalignment': 'baseline'}
plt.title(r"$\omega=2$, No Splitting", fontdict=subtitleDict, pad=7)
...
plt.plot(df['num_el_real'], df['y_prop'], '+--', linewidth=1.5, markersize=5)
plt.plot(df['num_el_real'], df['s_prop'], '+--', linewidth=1.5, markersize=5)
plt.plot(df['num_el_real'], df['z_prop'], '+--', linewidth=1.5, markersize=5)
plt.plot(df['num_el_real'], df['lagrange_prop'], '+--', linewidth=1.5, markersize=5)
plt.plot(df['num_el_real'], df['residual_prop'], '+--', linewidth=1.5, markersize=5)
plt.plot(df['num_el_real'], df['cost_prop'], '+--', linewidth=1.5, markersize=5)
plt.plot(df['num_el_real'], df['setup_prop'], '+--', linewidth=1.5, markersize=5)
...
plt.suptitle("CPU Time Distribution vs Number of Independent Variables", fontproperties=titleDict, y=0.96)
subtitleDict = { 'fontsize': 9, 'fontweight': 'normal', 'verticalalignment': 'baseline'}
plt.title(r"$\omega=1$, Splitting", fontdict=subtitleDict, pad=7)

# Lables and legend
plt.xlabel("# Independent Variables", fontsize=10)
plt.ylabel("Proportion of CPU Time", fontsize=10)
plt.legend(["Y Update", "z Update", "s Update", "Lagrange Update", "Residual Update", "Objective Update", "Setup"], loc=0)
...
# Processing and plotting
df = splittingMetaData.loc[splittingMetaData["omega"]==2]
...
plt.suptitle("CPU Time Distribution vs Number of Independent Variables", fontproperties=titleDict, y=0.96)
subtitleDict = { 'fontsize': 9, 'fontweight': 'normal', 'verticalalignment': 'baseline'}
plt.title(r"$\omega=2$, Splitting", fontdict=subtitleDict, pad=7)
